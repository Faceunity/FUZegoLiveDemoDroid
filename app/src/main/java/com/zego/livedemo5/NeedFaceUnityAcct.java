...
public class NeedFaceUnityAcct extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String isOpen = PreferenceUtil.getInstance().getStringValue(PreferenceUtil.KEY_FACEUNITY_ISON, "");
        ...
        btn_to_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NeedFaceUnityAcct.this, HomePageActivity.class);
                PreferenceUtil.getInstance().setStringValue(PreferenceUtil.KEY_FACEUNITY_ISON, isOn + "");
