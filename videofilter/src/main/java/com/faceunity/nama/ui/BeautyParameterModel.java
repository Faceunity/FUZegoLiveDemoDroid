...
public final class BeautyParameterModel {
     ...
     * 滤镜默认强度 0.4
     */
    public static final float DEFAULT_FILTER_LEVEL = 1f;
    ...
    private static float sColorLevel = 1f;// 美白
    private static float sBlurLevel = 1f; // 精细磨皮程度
    private static float sRedLevel = 0.0f;// 红润
    ...
    private static float sCheekV = 1f;//V脸
    private static float sCheekNarrow = 0f;//窄脸
    private static float sCheekSmall = 0f;//小脸
    private static float sEyeEnlarging = 1f;//大眼
    private static float sIntensityChin = 0.5f;//下巴
    private static float sIntensityForehead = 0.5f;//额头
    private static float sIntensityNose = 0.0f;//瘦鼻
    private static float sIntensityMouth = 0.5f;//嘴形
