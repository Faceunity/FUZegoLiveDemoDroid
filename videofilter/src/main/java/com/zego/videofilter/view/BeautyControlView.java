...
import com.zego.videofilter.faceunity.entity.BeautyParameterModel;
import com.zego.videofilter.faceunity.entity.Filter;
import com.zego.videofilter.faceunity.entity.FilterEnum;
import com.zego.videofilter.faceunity.utils.DecimalUtils;
import com.zego.videofilter.faceunity.utils.OnMultiClickListener;
import com.zego.videofilter.faceunity.utils.ToastUtil;
import com.zego.videofilter.view.dialog.BaseDialogFragment;
import com.zego.videofilter.view.dialog.ConfirmDialogFragment;
...
public class BeautyControlView extends FrameLayout implements TouchStateImageView.OnTouchStateListener {
    ...
    private OnFaceUnityControlListener mOnFUControlListener;
    ...
    public void setOnFUControlListener(@NonNull OnFaceUnityControlListener onFUControlListener) {
